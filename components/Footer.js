        ...
        <div className="grid gap-10 rounded-2xl border border-white/10 bg-white/5 p-5 shadow-2xl backdrop-blur-xl sm:rounded-[2rem] sm:p-8 md:grid-cols-2 lg:grid-cols-[1.3fr_0.9fr_0.9fr_1fr]">
          ...
          <div className="space-y-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-lg font-semibold text-white sm:text-xl">Learnova</p>
                <p className="text-[10px] uppercase tracking-[0.32em] text-fuchsia-200/80 sm:text-xs">Smart Learning</p>
              </div>
            </div>
            <p className="text-sm leading-6 text-slate-300 max-w-sm">AI-powered engagement and smart attendance for modern campuses.</p>
            <div>
              <Link href="/register" className="inline-flex items-center gap-2 rounded-full bg-white px-5 py-2.5 text-sm font-semibold text-slate-950 transition-transform duration-200 hover:-translate-y-0.5">
    ...
    {link.label}
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-xs text-slate-300 space-y-2">
              ...
              <Link href="/contact" className="inline-flex items-center gap-1 text-purple-400 hover:underline">Get in touch <ExternalLink size={11}/></Link>
            </div>
            ...
            <div className="rounded-xl border border-white/10 bg-gradient-to-br from-fuchsia-500/10 via-transparent to-cyan-500/10 p-4 sm:rounded-2xl">
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] leading-relaxed text-slate-300">Track attendance, reduce admin load, and keep every stakeholder aligned.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <motion.div className="mt-10 flex flex-col gap-6 border-t border-white/10 pt-6 items-center text-center sm:mt-12 sm:flex-row sm:justify-between sm:pt-8 sm:text-left" variants={itemVariants}>
        ...
        <div className="mt-12 flex justify-center select-none overflow-hidden sm:mt-16">
          {brandLetters.map((letter, i) => (
            <span key={i} className="text-[12vw] sm:text-[10vw] font-black text-white/5 cursor-default hover:text-purple-400/30 transition-all"
